...
int distribution()
{
    ...
    TH2* h123y = new TH2F("h123y", "Phase SPACEY", 100, -0.01,0.01, 100, -0.005, 0.005);
    TH2* h122 = new TH2F("h122", "size ", 100, -0.01,0.01, 100, -0.01, 0.01);
    //*******************************************************************
    ...
    for(int i=0;i<50;i=i+1){ 
        ...
        for(int ll=0;ll<nn;++ll){ 
            ...
            m1x=m4.multiply(mquadx,m1x);
            m1y=m4.multiply(mquady,m1y);
            x1 = m1x(0,0);
            xp1 = m1x(1,0);
            y1 = m1y(0,0);
            yp1 = m1y(1,0);
